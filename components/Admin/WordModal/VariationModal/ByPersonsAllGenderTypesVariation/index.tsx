...
export type ByPersonsAllGenderTypesVariationProps = {
...
const ByPersonsAllGenderTypesVariation = (props: ByPersonsAllGenderTypesVariationProps) => {
  const intl = useIntl();
  return (
    <div>
      <TextField
...
export default ByPersonsAllGenderTypesVariation;
