			...
			return (
				<Table>
					...
					<TableBody>
						<TableRow>
							<TableCell>
								{intl.formatMessage({ id: 'short.nominative' })}
							</TableCell>
						...
						<TableRow>
							<TableCell>
								{intl.formatMessage({ id: 'short.genitive' })}
							</TableCell>
						...
						<TableRow>
							<TableCell>
								{intl.formatMessage({ id: 'short.dative' })}
							</TableCell>
						...
						<TableRow>
							<TableCell>
								{intl.formatMessage({ id: 'short.accusative' })}
							</TableCell>
						...
						<TableRow>
							<TableCell>
								{intl.formatMessage({ id: 'short.instrumental' })}
							</TableCell>
						...
						<TableRow>
							<TableCell>
								{intl.formatMessage({ id: 'short.locative' })}
							</TableCell>
						...
						<TableRow>
							<TableCell>
								{intl.formatMessage({ id: 'short.vocative' })}
							</TableCell>
				...
				<Table>
					<TableHead>
						...
						<TableRow>
							<TableCell></TableCell>
							<TableCell>
								{intl.formatMessage({ id: 'short.masculine' })}
							</TableCell>
							<TableCell>
								{intl.formatMessage({ id: 'short.feminine' })}
							</TableCell>
							<TableCell>
								{intl.formatMessage({ id: 'short.neuter' })}
							</TableCell>
							<TableCell>
								{intl.formatMessage({ id: 'short.masculinePersonal' })}
							</TableCell>
							<TableCell>
								{intl.formatMessage({ id: 'short.nonMasculinePersonal' })}
							</TableCell>
						</TableRow>
					</TableHead>
					<TableBody>
				...
				<Table>
					...
					<TableBody>
						<TableRow>
							...
							<TableCell>
								{data?.firstPersonPluralMasculineFirst || '-'}
							</TableCell>
						...
						<TableRow>
							...
							<TableCell></TableCell>
							<TableCell>
								{data?.firstPersonPluralSecondMasculine || '-'}
							</TableCell>
							<TableCell>
								{data?.firstPersonPluralSecondNonMasculine || '-'}
							</TableCell>
						</TableRow>
						<TableRow>
							<TableCell>2.</TableCell>
							...
							<TableCell>
								{data?.secondPersonPluralMasculineFirst || '-'}
							</TableCell>
							<TableCell>
								{data?.secondPersonNonMasculineFirst || '-'}
							</TableCell>
						</TableRow>
						<TableRow>
							<TableCell></TableCell>
							...
							<TableCell></TableCell>
							<TableCell>
								{data?.secondPersonPluralMasculineSecond || '-'}
							</TableCell>
							<TableCell>
								{data?.secondPersonNonMasculineSecond || '-'}
							</TableCell>
						</TableRow>
						<TableRow>
							<TableCell></TableCell>
							...
							<TableCell></TableCell>
							<TableCell>
								{data?.secondPersonPluralMasculineThird || '-'}
							</TableCell>
							<TableCell>
								{data?.secondPersonNonMasculineThird || '-'}
							</TableCell>
						</TableRow>
						<TableRow>
							<TableCell>3.</TableCell>
				...
				<Table>
					...
					<TableBody>
						...
						<TableRow>
							...
							<TableCell></TableCell>
							<TableCell>
								{data?.firstPersonPluralMasculineSecond || '-'}
							</TableCell>
							<TableCell>
								{data?.firstPersonNonMasculineSecond || '-'}
							</TableCell>
						</TableRow>
						<TableRow>
							<TableCell>2.</TableCell>
