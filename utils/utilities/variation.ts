...
export const getSubPartList = (pos: PARTS_OF_SPEECH) => {
  switch (pos) {
    ...
    case PARTS_OF_SPEECH.ADJECTIVE: {
      return [SUB_PARTS_OF_SPEECH.INFLECTIV_ADJECTIVE, SUB_PARTS_OF_SPEECH.UNINFLECTIV_ADJECTIVE];
    }
    case PARTS_OF_SPEECH.NUMERAL: {
      return [SUB_PARTS_OF_SPEECH.INFLECTIV_NUMERAL, SUB_PARTS_OF_SPEECH.UNINFLECTIV_NUMERAL];
    }
